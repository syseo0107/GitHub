...
import getLayout from "components/getLayout"; // styled components
...
const ContactListView = () => {
  ...
  const handleSearch = value => setGlobalFilter(value || undefined); // handle pagination
      ...
      <Grid container>
        <Grid item lg={9} md={8} xs={12}>
          ...
          height: "100%"
            ...
            <Box px={3}>
              <SearchArea value={searchValue} onChange={handleSearch} setValue={setSearchValue} gridRoute="/contact-list/contact-grid-view" listRoute="/contact-list/contact-list-view" />
            </Box>
...
ContactListView.getLayout = getLayout; // ==============================================================
