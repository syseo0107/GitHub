      ...
      <Grid container>
        <Grid item lg={9} md={8} xs={12}>
          ...
          height: "100%"
            ...
            <SearchArea value={searchValue} onChange={handleSearch} gridRoute="/contact-list/contact-grid-view" listRoute="/contact-list/contact-list-view" />
...
ContactGridView.getLayout = getLayout; // ==============================================================
