  ...
  return <Box pt={2} pb={4}>
      ...
      padding: 4
        ...
        <Grid container spacing={3} mt={0}>
          <Grid item md={4} xs={6}>
            <H6 color="text.secondary">Order Number</H6>
            <H4 fontWeight={500}>#46876458</H4>
          </Grid>

          <Grid item md={4} xs={6}>
            <H6 color="text.secondary">Order Date</H6>
        ...
        <Box maxWidth={320}>
          ...
          <Box mt={4}>
            ...
            <Button variant="contained" size="small" onClick={() => push("/invoice/add-invoice")} sx={{
            fontSize: 12,
            fontWeight: 500,
...
InvoiceDetails.getLayout = getLayout; // ==============================================================
