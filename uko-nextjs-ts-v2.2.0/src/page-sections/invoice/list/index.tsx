  ...
  return (
    <Box>
      <Scrollbar autoHide={false}>
        <Table
          {...getTableProps()}
          sx={{ borderSpacing: "0 1rem", borderCollapse: "separate", minWidth: 900 }}
        >
          <TableHead>
            ...
            {page.map((row: any, index: number) => {
              ...
              return (
                <StyledTableRow
                  ...
                  {...row.getRowProps()}
                  sx={{ cursor: "pointer" }}
                  onClick={() => push("/invoice/invoice-details")}
                >
      ...
      <FlexBetween>
        ...
        <ButtonBase onClick={handleChange} disableRipple sx={{ fontSize: 13, fontWeight: 600 }}>
          View All
