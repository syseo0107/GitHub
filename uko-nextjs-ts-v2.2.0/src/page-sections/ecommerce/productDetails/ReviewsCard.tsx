...
function SingleReviewDetails({ title, progressValue, totalReview }: SingleReviewProps) {
  return (
    <FlexBetween>
  ...
  return (
    <Stack direction="row" alignItems="center" spacing={5}>
      <Stack alignItems="center" flexShrink={0}>
        <AppAvatar src="/static/avatar/002-girl.svg" sx={{ width: 60, height: 60 }} />
        <H5 mt={2} mb={0.5}>
          Chirstina Perry
        </H5>
      ...
      <Stack spacing={1} maxWidth={460}>
        ...
        <Paragraph fontSize={12} lineHeight={1.9}>
          Thank you very fast shipping from Poland only 3days. Very Greateful. Was this review
          helpful to you?.
        </Paragraph>
