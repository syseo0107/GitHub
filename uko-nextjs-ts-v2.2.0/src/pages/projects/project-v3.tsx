...
import { Box, Button, Card, Grid, styled, Tab, Theme, useMediaQuery } from "@mui/material";
        ...
        <Grid item xs={12}>
          <FlexBox justifyContent="space-between" flexWrap="wrap">
            <SearchInput
              ...
              sx={{ maxWidth: downSM ? "100%" : 270, marginBottom: downSM ? 1 : 0 }}
...
const tabItems = [
  { title: "All", amount: 45 },
  { title: "In Progress", amount: 12 },
  { title: "Upcoming", amount: 12 },
  { title: "Blocked", amount: 12 },
  { title: "Completed", amount: 12 },
];
...
// ==============================================================
UkoProjectV3.getLayout = getLayout;
// ==============================================================
