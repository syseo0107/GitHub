...
const AddInvoice = () => {
  ...
  const handleCancel = () => push("/invoice/invoice-list");
  ...
  return (
    <Box pt={2} pb={4}>
      <Card sx={{ padding: 4 }}>
        <H3 marginBottom={2}>Order Status</H3>

        <Formik
          initialValues={initialValues}
          validationSchema={validationSchema}
          onSubmit={(values) => console.log(values)}
          children={({ values, errors, touched, setFieldValue, handleChange, handleSubmit }) => {
            return (
...
// ==============================================================
AddInvoice.getLayout = getLayout;
// ==============================================================
