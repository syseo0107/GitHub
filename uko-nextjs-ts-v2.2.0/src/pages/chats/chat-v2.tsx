...
// styled components
const LeftButton = styled(Box)<{ screen: number | Breakpoint }>(({ theme, screen = "md" }) => ({
  top: 110,
  padding: 5,
  display: "flex",
  cursor: "pointer",
      ...
      <Grid container spacing={3}>
        ...
        <Grid item lg={6} md={7} xs={12}>
          <Card sx={{ position: "relative" }}>
            ...
            <LeftButton screen="lg" onClick={() => setOpenRight(true)} sx={{ right: 0 }}>
              <KeyboardArrowRight fontSize="small" color="disabled" />
            </LeftButton>

            <FlexBetween px={3} py={4}>
              <FlexBox alignItems="center">
                <Avatar src="/static/avatar/001-man.svg" sx={{ backgroundColor: "primary.200" }} />
                <Box marginLeft={1}>
                  <H4>Tom Cruise</H4>
...
const onlineNowList = [
  ...
  { image: "/static/avatar/003-boy.svg", offline: true },
  { image: "/static/avatar/004-woman.svg" },
  { image: "/static/avatar/010-girl-1.svg", offline: true },
  { image: "/static/avatar/020-man-4.svg" },
  { image: "/static/avatar/026-girl-4.svg", offline: true },
];
