...
import { Box, Button, ButtonBase, Grid, IconButton, Stack, styled, Theme } from "@mui/material";
...
const CustomButton = styled(ButtonBase)<{ active: string }>(({ active, theme }) => ({
  fontSize: 13,
  border: "none",
  fontWeight: 600,
