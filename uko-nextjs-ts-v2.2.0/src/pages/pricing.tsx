import { Box, Button, Card, Chip, Grid, Stack, styled, SvgIconProps, Switch } from "@mui/material";
        ...
        <Grid item xs={12}>
          <Stack direction="row" flexWrap="wrap" gap={3} justifyContent="center">
            <SingleCard
              ...
              features={["One Project", "Share it with 5 team members", "Sync across device"]}
            />
            <SingleCard
              price={99}
              type="Month"
